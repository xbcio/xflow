...
type serverConfig struct {
	...
	// silently start expiring codes an operator mints on the day they deploy
	// it. Meaningful only alongside --management (codes are minted there).
	//
	// It is a ceiling, not merely a default: a create request may ask for a
	// shorter lifetime, never a longer one, and a registration_code.create_global
