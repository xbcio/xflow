...
var (
	...
	// ErrRegistrationCodeExhausted comes from Consume, not ResolveByPlaintext:
	// the use count is state a lookup must not mutate.
	ErrRegistrationCodeExhausted = store.ErrRegistrationCodeExhausted
